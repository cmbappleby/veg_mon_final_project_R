...
::: {.card title='Point-Intercept Data'}
Words about the data.
The Uplands point intercept data is available at the [NPS DataStore](https://irma.nps.gov/DataStore/Reference/Profile/2305079). 
:::

## Column analysis {width='50%'}
